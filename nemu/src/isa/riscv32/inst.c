...
// 算术运算指令 - M 扩展
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, temp = (sword_t)src1*(word_t )src2, R(rd) = temp >> 32);
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, temp = (word_t )src1*(word_t )src2, R(rd) = temp >> 32);
