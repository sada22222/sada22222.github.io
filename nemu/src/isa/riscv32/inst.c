...
// 算术运算指令 - M 扩展
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(rd) = (int32_t)(src1 * src2));  // 乘法
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = ((int64_t)src1 * (int64_t)src2) >> 32); // 有符号乘法，高 32 位
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = ((int64_t)src1 * (uint64_t)src2) >> 32); // 有符号和无符号乘法，高 32 位
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = ((uint64_t)src1 * (uint64_t)src2) >> 32); // 无符号乘法，高 32 位

  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0) ? ((int32_t)src1 / (int32_t)src2) : -1); // 有符号除法
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2 != 0) ? (src1 / src2) : UINT32_MAX); // 无符号除法
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2 != 0) ? ((int32_t)src1 % (int32_t)src2) : src1); // 有符号取余
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = (src2 != 0) ? (src1 % src2) : src1); // 无符号取余
